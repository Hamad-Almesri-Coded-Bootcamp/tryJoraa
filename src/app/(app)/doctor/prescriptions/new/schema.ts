// Lane A owns src/lib/validation; colocated until doctorPrescriptionSchema
// ships there (.plans/b.md).
import { z } from 'zod'
...
export type DoctorPrescriptionInput = z.infer<typeof doctorPrescriptionSchema>
